        ...
        <aside id="claire-aside" class=" navbar-nav">
            ...
            <header>
                 <nav id="claire-main-menu">
                    <ul class="ml-5">
                        <li <?=$l1?> ><a href='index.php'>Home</a></li>
                        <li <?=$l2?> ><a href='about.php'>About Us</a></li>
                        <li <?=$l3?> ><a href='questions.php'>Questions</a></li>
                        <li <?=$l4?> ><a href='updates.php'>Updates</a></li>
                        <li <?=$l5?> ><a href='login.php'>Login</a></li>
                        <li <?=$l6?> ><a href='subscribe.php'>Subscribe</a></li>
